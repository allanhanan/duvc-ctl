...
const wchar_t *to_wstring(CamProp p) {
  ...
  case CamProp::Privacy:
    return L"Privacy";
  case CamProp::PanRelative:
    return L"PanRelative";
  case CamProp::TiltRelative:
    return L"TiltRelative";
  case CamProp::RollRelative:
    return L"RollRelative";
  case CamProp::ZoomRelative:
    return L"ZoomRelative";
  case CamProp::ExposureRelative:
    return L"ExposureRelative";
  case CamProp::IrisRelative:
    return L"IrisRelative";
  case CamProp::FocusRelative:
    return L"FocusRelative";
  case CamProp::PanTilt:
    return L"PanTilt";
  case CamProp::PanTiltRelative:
    return L"PanTiltRelative";
  case CamProp::FocusSimple:
    return L"FocusSimple";
  case CamProp::DigitalZoom:
    return L"DigitalZoom";
  case CamProp::DigitalZoomRelative:
    return L"DigitalZoomRelative";
  case CamProp::BacklightCompensation:
...
const wchar_t *to_wstring(VidProp p) {
  ...
  case VidProp::Gamma:
    return L"Gamma";
  case VidProp::ColorEnable:
    return L"ColorEnable";
  case VidProp::WhiteBalance:
    return L"WhiteBalance";
  case VidProp::BacklightCompensation:
    return L"BacklightCompensation";
  case VidProp::Gain:
    return L"Gain";
