 ...
 * 
 * @internal Internal utilities for mapping between duvc enums and DirectShow constants.
 */
...
public:
     ...
     * @param is_camera_control true for IAMCameraControl, false for IAMVideoProcAmp
