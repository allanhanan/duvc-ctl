...
html_logo = None  # Will be added in Phase 2
html_favicon = None  # Will be added in Phase 2
html_use_index = True
...
ogp_social_cards = {
    "enable": False,  # Will be enabled in Phase 2 when we add images
}
...
def setup(app):
    """Custom Sphinx setup."""
    # Add custom CSS/JS processing here in Phase 2
    pass
