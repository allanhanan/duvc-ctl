...
- [duvc-ctl C++ Documentation](#duvc-ctl-c-documentation)
  ...
  - [C++ API Classes \& Functions](#c-api-classes--functions)
    ...
    - [Property Enumerations](#property-enumerations)
      - [Camera Control Properties](#camera-control-properties)
      - [Video Processing Properties](#video-processing-properties)
    - [Core Functions](#core-functions)
      - [Device Management](#device-management-1)
        - [duvc::list\_devices()](#duvclist_devices)
        - [duvc::is\_device\_connected()](#duvcis_device_connected)
      - [Property Operations](#property-operations)
        - [duvc::get() - Camera Properties](#duvcget---camera-properties)
        - [duvc::get() - Video Properties](#duvcget---video-properties)
        - [duvc::set() - Camera Properties](#duvcset---camera-properties)
        - [duvc::set() - Video Properties](#duvcset---video-properties)
        - [duvc::get\_range() - Property Ranges](#duvcget_range---property-ranges)
    - [High-Performance Classes](#high-performance-classes)
      - [DeviceConnection Class](#deviceconnection-class)
    - [Vendor Extensions](#vendor-extensions)
      - [Logitech Support](#logitech-support)
      - [KsPropertySet Class](#kspropertyset-class)
      - [Vendor Property Utilities](#vendor-property-utilities)
  ...
  - [C++ API Examples](#c-api-examples)
    - [Basic Device Control](#basic-device-control)
      - [Example 1: List and Display Device Information](#example-1-list-and-display-device-information)
      - [Example 2: Basic Property Control](#example-2-basic-property-control)
    - [Advanced Property Control](#advanced-property-control)
      - [Example 3: Complete Camera Property Survey](#example-3-complete-camera-property-survey)
    - [High-Performance Connection Management](#high-performance-connection-management)
      - [Example 4: Bulk Property Operations with DeviceConnection](#example-4-bulk-property-operations-with-deviceconnection)
    - [Vendor-Specific Extensions](#vendor-specific-extensions)
      - [Example 5: Logitech Camera Control](#example-5-logitech-camera-control)
    - [Error Handling and Logging](#error-handling-and-logging)
      - [Example 6: Comprehensive Error Handling](#example-6-comprehensive-error-handling)
    - [Building the Examples](#building-the-examples)
      - [CMakeLists.txt for Examples](#cmakeliststxt-for-examples)
